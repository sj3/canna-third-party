...
openerp.account_analytic_required = function (instance) {
    ...
    instance.web.account.bankStatementReconciliation.include({
        ...
        init: function(parent, context) {
            ...
            /* 
            the 'this.required_fields_set' is used to check if all required fields 
    ...
    instance.web.account.bankStatementReconciliationLine.include({
        ...
        UpdateRequiredFields: function(elt) {
            ...
            console.log('this.required_fields_set', this.required_fields_set);
        },
        ...
        formCreateInputChanged: function(elt, val) {
            ...
            var balanceChangedFlag = self.CheckRequiredFields(elt);
