...
class BaseOperatingUnitIsolation(models.AbstractModel):
    ...
    def _register_hook(self):
        ...
        @api.model
        def _ou_search(self, args, offset=0, limit=None, order=None, count=False, access_rights_uid=None):
            ...
            if (record
                ...
                if getattr(fld, "operating_unit_isolation", False):
                    ...
                    if len(isolation) == 2:
                        ...
                        if isolation[0] == parent_record["_o2m"]:
            ...
            return _ou_search.origin(self, args, offset=offset, limit=limit, order=order, count=count, access_rights_uid=access_rights_uid)
